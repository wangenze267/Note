import{_ as s,c as n,o as a,a as e}from"./app.5dd0f682.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"前言","slug":"前言","link":"#前言","children":[]},{"level":2,"title":"源码目录结构","slug":"源码目录结构","link":"#源码目录结构","children":[]}],"relativePath":"fe_advance/Vue/Vue2源码解析/index.md"}'),l={name:"fe_advance/Vue/Vue2源码解析/index.md"},p=e(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-hidden="true">#</a></h2><p>前端的竞争日益激烈，相信大家在面试中有所体会，如何在竞争中脱颖而出，阅读源码是必不可少的技能；目前国内vue和react最为火热，react源码相对较难，最好从vue先入手，vue一万行多代码该如何下手，也是很多人放弃看源码的原因，那我们就不妨慢慢来吧。</p><p>相信会有收获！</p><blockquote><p>v2.6.11版本</p></blockquote><h2 id="源码目录结构" tabindex="-1">源码目录结构 <a class="header-anchor" href="#源码目录结构" aria-hidden="true">#</a></h2><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">├─ .circleci                 # 包含CircleCI持续集成/持续部署工具的配置文件</span></span>
